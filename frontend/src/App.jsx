    ...
    <div className="app">
      ...
      <main className="main">
        ...
        <div className="info-banner">
          <strong>Trained on the ISOT dataset</strong> — ~44,900 real and fake news
          articles. Paste any news article body text below. Works best with 3+ sentences.
        </div>
        ...
        {result && (
          <div
            ref={resultRef}
            className={`result-card ${isFake ? "result-fake" : "result-real"}`}
          >
              ...
              <div className="keywords-section">
                <div className="keywords-title">
                  ...
                  <span className="keywords-hint">
                    {" "}— TF-IDF features that drove this prediction
                  </span>
                </div>
            ...
            <div className="result-disclaimer">
              This is an ML prediction, not a verified fact-check. Always consult
              primary sources.
            </div>
          </div>
        )}
      ...
      <footer className="footer">
        <p>
          Powered by scikit-learn · ISOT Dataset · Built with Flask + React
        </p>
      </footer>
